        ...
        Card(modifier = Modifier.fillMaxWidth()) {
            Column(
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(16.dp)
                    .padding(top = 48.dp) // Ajuste adicionado aqui para mover o conteúdo para baixo
            ) {
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    IconButton(onClick = {
                        var call = RetrofitFactory().getCepService().getEnderecoByUFCidade(uf = ufState,cidade = cidadeState, rua = ruaState)
